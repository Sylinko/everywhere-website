...
* **Everywhere Cloud Search (Recommended):** We have officially launched the Everywhere Cloud Search service. You can enable web access instantly by using your account credits or the monthly search quota included in your [subscription plan](/en/pricing), with no complex configuration required.
