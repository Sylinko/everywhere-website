---
title: Saving Tokens
description: How to better manage and optimize token consumption in Everywhere to reduce your costs.
icon: Wallet
---
...
<HorizontalImg
    src="/get-started/guides/saving-tokens/en/chat-window-settings.webp"
...
*   **Effect**: This setting limits how many recent user-message rounds are kept in context. One round consists of one user mesage and the corresponding assistant response.
*   **Recommendation**: For complex tasks that require continuous context, you can increase the rounds appropriately; for simple single-turn interactions, keeping fewer rounds can save tokens.
...
<HorizontalImg
    src="/get-started/guides/saving-tokens/en/chat-settings-automatically-add-element.webp"
...
Everywhere provides a default system prompt for general use cases. Please <DynamicLink href="/[lang]/docs/assistants#system-prompt">refer to the Assistants page</DynamicLink> for details.
...
<HorizontalImg
    src="/get-started/guides/saving-tokens/en/chat-window-tools.webp"
