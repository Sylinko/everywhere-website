---
title: Assistants
description: Create, configure, and manage your AI assistants in Everywhere.
icon: Brain
---
...
- **Tool Usage Support**  
  Enable this option to allow the model to use the tools you have configured. **If the model does not support tool usage, enabling this option may cause request failures.**
...
- If you click the rightside Reset button, this setting will be ignored in the request body.
- If this setting disappears, it means that the model you are using does not support this parameter.
</Callout>
...
For models that support dynamic reasoning toggling, this option can be used to disable model reasoning. Leaving it blank means this parameter will not be included in the request.

<Callout type="info">
If set to other values, the behavior of this parameter in the request body may vary depending on the API protocol. If the effect is not as expected, please try adjusting it again.
</Callout>

#### Reasoning Effort (reasoning_effort)

Select a custom reasoning intensity. Leaving it blank means this parameter will not be included in the request. 
...
Set the budget for reasoning output, measured in tokens.

<Callout type="info">
If set, the behavior of this parameter in the request body may vary depending on the API protocol. If the effect is not as expected, please try adjusting it again.
</Callout>
