---
title: Moonshot (Kimi)
description: Obtain your Moonshot (Kimi) API key and configure it to power your Everywhere assistant.
---
...
In the preset mode, Everywhere will connect to the China mainland site of Moonshot (Kimi). You need to visit [platform.moonshot.cn](https://platform.moonshot.cn) to get an API key.
...
<Callout type="warning" title="Billing">
