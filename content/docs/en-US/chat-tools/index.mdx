...
We welcome developers familiar with C# to contribute more built-in tools to Everywhere. If you have a great idea or have already implemented a tool, please share it with us by [submitting a Pull Request](https://github.com/DearVa/Everywhere/pulls).
