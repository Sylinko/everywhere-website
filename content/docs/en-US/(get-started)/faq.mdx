...
### Why can't the PowerShell tool automatically approve?

For security reasons, the PowerShell tool in **Everywhere** does not automatically approve permission requests. You need to manually approve each time the AI needs to use the PowerShell tool.