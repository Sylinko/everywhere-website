---
title: Ollama
description: 配置 Ollama，为你的 Everywhere 助手提供模型能力。
---
...
- 在 Everywhere 的自定义助手中切换至 **进阶模式**：
  - 将**URL**设置为`http://127.0.0.1:11434`（Ollama 的默认地址）
  - 将**模型 ID**设置为`gemma3:12b`（或您下载的其他模型名称）
