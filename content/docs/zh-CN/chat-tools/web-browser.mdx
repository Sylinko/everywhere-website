---
title: 网络浏览器
description: 配置网页浏览器工具，赋予你的助手实时的互联网访问与搜索能力。
icon: PanelsTopLeft
---
...
<Callout type="warning" title="重要通知">
Google Custom Search JSON API 已宣布将于 2027 年 1 月 1 日正式关闭服务，且本教程中的内容已经过时。强烈建议您选择并使用上述其他的搜索引擎服务。

详情请参阅 [Google 的公告](https://programmablesearchengine.googleblog.com/2026/01/updates-to-our-web-search-products.html)。
</Callout>

本教程将一步步指导您如何在 Everywhere 中使用 [Google](https://developers.google.com/custom-search/v1/overview) 作为网络搜索服务。
...
<HorizontalImg
    src="/chat-tools/web-browser/google/project-manager.webp"
    alt="项目选择器"
    width="600px"
  />
...
<HorizontalImg
    src="/chat-tools/web-browser/google/create-project.webp"
    alt="创建项目"
    width="500px"
  />
