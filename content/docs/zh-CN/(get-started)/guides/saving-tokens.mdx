---
title: 成本控制
description: 了解如何在 Everywhere 中更好地管理和优化 Token 消耗，降低使用成本。
icon: Wallet
---
...
<HorizontalImg
    src="/get-started/guides/saving-tokens/zh-CN/chat-window-settings.webp"
    alt="聊天窗口设置"
    width="200px"
  />
...
<HorizontalImg
    src="/get-started/guides/saving-tokens/zh-CN/chat-settings-automatically-add-element.webp"
    alt="聊天设置 - 自动添加元素"
    width="500px"
  />
...
Everywhere 默认提供了通用场景的系统提示词，请<DynamicLink href="/[lang]/docs/ai-assistant#系统提示词">参阅</DynamicLink>。
...
<HorizontalImg
    src="/get-started/guides/saving-tokens/zh-CN/chat-window-tools.webp"
    alt="聊天窗口 - 工具"
    width="200px"
  />
